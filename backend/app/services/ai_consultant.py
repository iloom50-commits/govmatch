...
- done: **절대 첫 응답(대화 메시지가 1개일 때)에서는 done=true로 설정하지 마세요.** 첫 응답은 반드시 done=false이고, 공고 정보를 안내한 뒤 후속 질문을 유도하세요. **done=true는 사용자가 구체적 조건을 제공하고 자격 판단을 요청한 경우(최소 2~3턴 이후)에만 설정하세요.**
