          ...
          <div className="mt-4 bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: "이용 요금이 궁금해요", a: "지원금 매칭(찾기)은 무료·무제한입니다. AI 기능은 크레딧(1크레딧=1원)으로 이용하며, 공고 상담/분석 50, 자금상담 AI 100(대화 세션당), 전문가 도구 500, 신청서 문서 1건 9,900 크레딧이 차감됩니다. 가입 시 500 크레딧을 드립니다." },
                { q: "크레딧은 어떻게 충전하나요?", a: "충전팩은 19,000원→20,000 / 49,000원→60,000 / 99,000원→150,000 / 199,000원→400,000 크레딧입니다. 필요할 때 선불로 충전해 사용하며, 정기결제나 자동결제는 없습니다." },
                { q: "환불은 어떻게 하나요?", a: "유료로 충전한 미사용 크레딧은 고객센터 문의를 통해 환불받을 수 있습니다(PG 결제수수료가 공제될 수 있음). 가입 보너스·프로모션 등 무상 크레딧은 환불되지 않습니다." },
              ].map((faq) => (
