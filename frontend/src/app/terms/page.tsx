  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-slate-800">
      ...
      <section className="space-y-6 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-bold mb-2">제6조 (유료 서비스 및 크레딧)</h2>
          <ul className="list-disc ml-5 space-y-1">
            <li>유료 서비스의 종류 및 이용 요금(크레딧 차감량)은 서비스 내 안내 페이지에 게시합니다.</li>
            <li>유료 서비스는 크레딧(1크레딧 = 1원)을 선불로 충전하여 이용하는 방식이며, 구독·정기결제·자동결제는 제공하지 않습니다.</li>
            <li>회원은 필요한 만큼 크레딧을 충전하고, 유료 기능 이용 시 해당 크레딧이 차감됩니다.</li>
            <li>충전한 크레딧의 유효기간은 충전일로부터 12개월이며, 충전 즉시 이용 가능한 디지털 콘텐츠입니다.</li>
            <li>결제(충전)는 신용카드, 계좌이체, 가상계좌, 간편결제를 통해 이루어집니다.</li>
          </ul>
        </div>

        <div>
          <h2 className="text-lg font-bold mb-2">제7조 (크레딧 환불)</h2>
          <ul className="list-disc ml-5 space-y-1">
            <li>유료로 충전한 미사용 크레딧은 고객센터 문의를 통해 환불받을 수 있습니다.</li>
            <li>이미 사용(차감)된 크레딧, 가입 보너스·프로모션 등 무상 크레딧은 환불되지 않습니다.</li>
            <li>기타 자세한 환불 정책은 별도의 환불 정책 페이지에 따릅니다.</li>
          </ul>
        </div>
