...
${convHtml}
<div style="margin-top:30px;padding-top:15px;border-top:1px solid #e2e8f0;color:#94a3b8;font-size:11px;text-align:center">지원금길잡이 AI 상담 보고서 · govmatch.kr</div>
</body></html>`;
  };
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-8 overflow-y-auto overscroll-contain">
              <div className="max-w-md text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 mb-2">AI 서비스</h2>
