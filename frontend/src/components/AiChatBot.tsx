  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-end gap-3">
      <div className="flex flex-col items-end gap-2">
        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-blue-200 rounded-full shadow-lg">
          <span className="text-[12px] font-bold text-blue-700">{label}</span>
        </div>
        {/* 버튼 */}
        <button
          onClick={onClick}
